...
很好，至少你知道打開這個軟件。我是你的論文指導教授，**不要期望我對你手下留情**。

## 聽好了，這是你能做的事：

- **選論文**：左邊那一堆，挑一篇你能看懂的（如果有的話）
- **換語言**：中英文看不懂？按上面那個按鈕切換，別指望換了語言就能理解內容
- **問問題**：有不懂的就右邊提問，我會回答，雖然你的問題可能很蠢
- **看摘要**：懶得讀全文？我給你總結重點，省得你到處抓瞎

## 開始用吧，別磨蹭！

從左邊隨便選一篇，然後開始讀。有不明白的就問我，**別憋著裝懂**！

記住：_真正的學術是刀尖起舞，而不是像你平時那樣淺嘗輒止！_
